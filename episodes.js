let currentPageUrl = 'https://api.attackontitanapi.com/episodes';
    ...
    try {
        ...
        responseJson.results.forEach((character) => {
            ...
            card.onclick = () => {
                ...
                episode.innerText = `Episode: ${character.episode}`;

                const numCharacters = document.createElement("span");
                numCharacters.className = "character-details";
                numCharacters.innerText = `Number of Characters: ${character.characters.length}`;

                modalContent.appendChild(characterImage);
                modalContent.appendChild(name);
                modalContent.appendChild(episode);
                modalContent.appendChild(numCharacters);
            }
