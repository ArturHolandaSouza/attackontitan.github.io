let currentPageUrl = 'https://api.attackontitanapi.com/characters?page=1';
    ...
    try {
        ...
        responseJson.results.forEach((character) => {
            ...
            card.onclick = () => {
                ...
                gender.innerText = `Sex: ${character.gender}`;

                const age = document.createElement("span");
                age.className = "character-details";
                ...
                occupation.className = "character-details";
                occupation.innerText = `Ocupation: ${character.occupation}`;
                ...
                modalContent.appendChild(occupation);
            }
